...
class NstAltName(models.Model):
    ...
    main_entry = models.ForeignKey('NstLocation', models.DO_NOTHING, db_column='main_entry')
...
class NstLocation(models.Model):
    ...
    neighborhood = models.ForeignKey('NstNeighborhood', models.DO_NOTHING, db_column='location', blank=True, null=True)
    ...
    park_system = models.ForeignKey('NstParkSystem', models.DO_NOTHING, db_column='park_system', blank=True, null=True)
    resident_history = models.ManyToManyField(
        'NstRotationDate',
        through='NstSpeciesListArchive',
        symmetrical=True
    )
...
class NstMetropolisMajor(models.Model):
    ...
    short_name = models.CharField(db_column='Shortname', max_length=88, blank=True, null=True)
    lat = models.FloatField(blank=True, null=True)
    lon = models.FloatField(blank=True, null=True)
...
class NstNeighborhood(models.Model):
    name = models.CharField(max_length=222)
    region = models.ForeignKey(NstCombinedRegion, models.DO_NOTHING, db_column='region', blank=True, null=True)
    lat = models.FloatField(blank=True, null=True)
    lon = models.FloatField(blank=True, null=True)
    major_city = models.ForeignKey(NstMetropolisMajor, models.DO_NOTHING, db_column='major_city', blank=True, null=True)
...
class NstSpeciesListArchive(models.Model):
    rotation_num = models.ForeignKey(NstRotationDate, models.DO_NOTHING, db_column='rotation_num')
